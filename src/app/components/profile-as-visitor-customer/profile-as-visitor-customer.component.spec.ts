...
import { ProfileAsCustomerComponent } from './profile-as-visitor-customer.component';
import { FormsModule } from '@angular/forms';
import { BrowserAnimationsModule } from '@angular/platform-browser/animations';
import { PickerModule } from '@ctrl/ngx-emoji-mart';

describe('ProfileComponent', () => {
  let component: ProfileAsCustomerComponent
  let fixture: ComponentFixture<ProfileAsCustomerComponent>;
  ...
  beforeEach(async () => {
    ...
    fixture = TestBed.createComponent(ProfileAsCustomerComponent);
