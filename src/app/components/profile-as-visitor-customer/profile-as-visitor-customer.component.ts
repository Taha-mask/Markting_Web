...
@Component({
  selector: 'app-profile-as-visitor-customer',
  standalone: true,
  imports: [RouterModule, FormsModule, CommonModule, PickerModule],
  templateUrl: './profile-as-visitor-customer.component.html',
  styleUrls: ['./profile-as-visitor-customer.component.css'],
  animations: [
    trigger('fadeInOut', [
      transition(':enter', [
        style({ opacity: 0 }),
...
export class ProfileAsVisitorCustomerComponent implements OnInit, OnDestroy, CanActivate {
  @ViewChild('fileInput') fileInput!: ElementRef;
  @ViewChild('postImageInput') postImageInput!: ElementRef;

  isDropdownVisible = false;
  currentUser = 'Elhusseini Ahmed';
  ...
  scrollLeft: number = 0;
  startX: number = 0;
  bio: string = 'Every day is a new opportunity to improve yourself. Take it and make the most of it.';
