...
@Component({
  selector: 'app-profile-as-customer',
  standalone: true,
  imports: [RouterModule, FormsModule, CommonModule, PickerModule],
  templateUrl: './profile-as-customer.component.html',
  styleUrls: ['./profile-as-customer.component.css'],
  animations: [
    trigger('fadeInOut', [
      transition(':enter', [
        style({ opacity: 0 }),
...
export class ProfileAsCustomerComponent implements OnInit, OnDestroy, CanActivate {
